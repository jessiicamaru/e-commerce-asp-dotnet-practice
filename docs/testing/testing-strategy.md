...
| :-- | :-- | :-- | :-- | :-- |
| Service integration tests | xUnit, real PostgreSQL | `server/tests/Ecommerce.<Service>.Tests/` | 574 test cases in 8 projects | Business rules, locking, guarded updates, unique constraints, idempotence, what is published |
| Storefront unit tests | Vitest, jsdom, Testing Library | `client/src/**/*.test.ts(x)` | 300 tests in 54 files | What a page asks for, what a form sends, what a guard lets through, how a server refusal is shown |
| API collection | Bruno CLI | `bruno/` | 194 requests, 316 assertions | Every public endpoint through the gateway, with real tokens, including 401/403/404/409 cases |
...
| :-- | :-- | :-- | :-- |
| `Ecommerce.Identity.Tests` | 5435 | 101 | AddressBook, Audit, AuthError, Email, EmailCase, ForbiddenProblem, JwtStartup, Moderation, PasswordReset, RefreshTokenReuse, RegistrationValidation, SellerRoles, Session, ShopApplication, UserReport |
