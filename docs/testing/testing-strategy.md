...
| :-- | :-- | :-- | :-- | :-- |
| Service integration tests | xUnit, real PostgreSQL | `server/tests/Ecommerce.<Service>.Tests/` | 566 test cases in 8 projects | Business rules, locking, guarded updates, unique constraints, idempotence, what is published |
...
| :-- | :-- | :-- | :-- |
| `Ecommerce.Identity.Tests` | 5435 | 93 | AddressBook, Audit, AuthError, Email, EmailCase, ForbiddenProblem, JwtStartup, Moderation, RefreshTokenReuse, RegistrationValidation, SellerRoles, Session, ShopApplication, UserReport |
