...
The defects first - #122 and #123 can remove the wrong cart line or sell stock the shop no longer
holds, then #124 to #128. Then email (#102), which unblocks two others: #102 -> #103 -> #104 -> #105 ->
