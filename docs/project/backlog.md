...
The defects are done, email exists (#102), a password can be reset (#103), guessing is limited (#105), addresses are confirmed (#106) and a person manages their own account (#104). Next: #112 -> #107 -> #108 -> #111, and
