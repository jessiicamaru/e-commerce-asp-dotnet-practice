...
| Database tables (excluding outbox) | 46 ([reference](../reference/data-model.md)) |
| Service, saga and gateway tests | 740, in 9 projects |
| Storefront unit tests | 407 |
| Bruno requests | 238 |
| Design records (`specs/`) | 63 |
