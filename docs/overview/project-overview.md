...
| Database tables (excluding outbox) | 48 ([reference](../reference/data-model.md)) |
| Service, saga and gateway tests | 763, in 9 projects |
| Storefront unit tests | 435 |
| Bruno requests | 256 |
| Design records (`specs/`) | 65 |
