...
| Database tables (excluding outbox) | 35 ([reference](../reference/data-model.md)) |
| Service and saga tests | 574, in 8 projects |
| Storefront unit tests | 300 |
| Bruno requests | 194 |
| Design records (`specs/`) | 49 |
