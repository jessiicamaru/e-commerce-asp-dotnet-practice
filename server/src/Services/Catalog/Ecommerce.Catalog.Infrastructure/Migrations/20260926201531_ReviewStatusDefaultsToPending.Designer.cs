...
namespace Ecommerce.Catalog.Infrastructure.Migrations
{
    ...
    [Migration("20260926201531_ReviewStatusDefaultsToPending")]
    partial class ReviewStatusDefaultsToPending
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Catalog.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<Guid?>("ImageAccessKey")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecommerce.Catalog.Domain.Entities.ProductView", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ecommerce.Catalog.Domain.Entities.ProductViewer", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("ProductId", "Day", "Viewer");

                    b.ToTable("product_viewers", (string)null);
                });
            ...
            modelBuilder.Entity("Ecommerce.Catalog.Domain.Entities.SavedProduct", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CustomerId", "SavedAt");

                    b.ToTable("saved_products", (string)null);
                });
