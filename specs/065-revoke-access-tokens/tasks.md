...
- [ ] T001 [US1] [US2] Tests first. Cover:
...
- [ ] T002 [US1] The contract, `RevokedAccessTokens`, the `OnTokenValidated` hook and the consumer with its registration extension.
- [ ] T003 [US1] Identity publishes in all six places. Every service registers the consumer.
- [ ] T004 End to end:
