...
`vite.config.ts` and `tsconfig.app.json`, so generated files need no editing.
...
PostgreSQL on 5434), `Ecommerce.Catalog.Tests` (129 tests, PostgreSQL on 5433), `Ecommerce.Cart.Tests`
